---
title: "ALEA-R overview"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{ALEA-R overview}
...
quantile estimation, bootstrap confidence intervals, goodness-of-fit
...
ALEA-R uses S3 classes for user-facing objects. The main classes include:

| Class | Purpose |
|---|---|
| `alea_fit` | One fitted distribution for one sample |
| `alea_quantile` | Quantile estimates |
| `alea_quantile_ci` | Bootstrap confidence intervals for quantiles |
| `alea_gof` | Goodness-of-fit statistics and information criteria |
| `alea_diagnostics` | Sample diagnostics |
| `alea_selection` | AI-assisted distribution-selection support |
| `alea_batch` | Batch analysis for multiple stations or sites |

# Single-site workflow

```{r single-site, eval = FALSE}
library(ALEA)
...
distribution, method, quantile calculation, goodness-of-fit calculation,
